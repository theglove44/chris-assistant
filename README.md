...
5. After the draft PR opens, Symphony posts the CI results back on the GitHub issue.
6. Reviewer assignment stays manual in v1; landing stops at a draft PR so a human can inspect before review handoff.
